...
public class Board extends Observable implements TetrisControlls {
    ...
    /**
     * This returns the current Piece.
     * @return current piece we're playing.
     */
    public MovableTetrisPiece getCurrentPiece() {
        return myCurrentPiece;
    }
    
    /**
     * This returns the current frozen blocks.
     * @return current blocks that are frozen.
     */
    public List<Block[]> myFrozenBlocks() {
        return myFrozenBlocks;
    }
    
    /**
     * This returns the next Piece.
     * @return next piece we're playing.
     */
    ...
    /**
     * This returns our current score in game.
     * @return an int for score.
     */
    public int getScore() {
        return score;
    }
    ...
    /**
     * This returns if game is over.
     * @return current T/F if game is over.
     */
